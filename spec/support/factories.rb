module Factories
  ...
  def build_user name: nil, ordering: false, phone_number: nil, telegram_id: nil, medlink_id: nil
    User.new \
      ...
      medlink_id:    medlink_id  || rand(1 .. 10_000),
      medlink_token: rand(1 .. 10_000).to_s
  end
